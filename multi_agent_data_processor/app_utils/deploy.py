...
@click.option(
    "--requirements-file",
    default="multi_agent_data_processor/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to multi_agent_data_processor/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
